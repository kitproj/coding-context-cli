// Package parser provides common functionality for parsing markdown files with YAML frontmatter.
package parser
...
// The frontmatter parameter should be a pointer to the struct or map where
// the YAML frontmatter will be unmarshaled.
