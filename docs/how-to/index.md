...
Practical guides to solve specific problems with the Coding Context CLI.

These guides are problem-oriented and help you achieve specific goals.
...
- [Use Shell Outputs](./use-shell-outputs) - Include dynamic runtime context
